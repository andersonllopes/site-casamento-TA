  ...
  return (
    <div className="min-h-screen">
      <section
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(https://images.pexels.com/photos/265722/pexels-photo-265722.jpeg?auto=compress&cs=tinysrgb&w=1920)',
        }}
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center">
              <img
                ...
                alt="Anderson"
                className="w-64 h-64 rounded-full mx-auto object-cover shadow-lg mb-6"
              />
